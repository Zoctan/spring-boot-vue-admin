<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form status-icon class="small-space" label-position="left" label-width="75px" style="width: 300px; margin-left:50px;"
               :model="tmpUser"
               :rules="createRules"
               ref="tmpUser">
        ...
        <el-form-item label="Password" prop="password"
                      v-if="dialogStatus === 'add'" required>
          <el-input type="password" prefix-icon="el-icon-edit" auto-complete="off"
                    :readonly="readonly"
